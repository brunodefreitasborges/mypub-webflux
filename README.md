...
```
cd existing_repo
git remote add origin https://gitlab.com/brunofborges/my-pub-multi-modules.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/brunofborges/my-pub-multi-modules/-/settings/integrations)
